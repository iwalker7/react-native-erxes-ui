...
export const Brand = {
  ...
  coreMediumGray: '#6a818c',
  coreDarkGray: '#373737',
};

export const lightGray = '#AAA';

export const primary = '#5629B6';
export const secondary = '#fda50f';
export const primaryDark = '#673FBD';
export const primaryLight = '#EA475D';

export const coreRed = '#EA475D';
export const coreYellow = '#fda50f';
export const coreOrange = '#FF6600';
export const coreGreen = '#3CCC38';
export const coreBlue = '#3B85F4';

export const coreTeal = '#63D2D6';
export const coreDarkBlue = '#0a1e41';
export const coreBlack = '#393C40';
export const coreGray = '#888';
export const coreLightGray = '#AAAEB3';
export const coreMediumGray = '#6a818c';
export const coreDarkGray = '#373737';

export const primary1 = rgba(primary, 0.8);

export const primaryDark1 = darken(primary, 12);
export const primaryDark2 = darken(primary, 28);
export const primaryDark3 = darken(primaryDark, 40);

export const primaryLight1 = rgba(primaryLight, 0.12);
export const primaryLight2 = rgba(primaryLight, 0.28);
export const primaryLight3 = rgba(primaryLight, 0.4);

export const secondaryDark1 = darken(secondary, 12);
export const secondaryDark2 = darken(secondary, 28);
export const secondaryDark3 = darken(secondary, 40);

export const secondaryLight1 = lighten(secondary, 12);
export const secondaryLight2 = lighten(secondary, 28);
export const secondaryLight3 = lighten(secondary, 40);

export const onSurfaceHigh = '#000000';
export const onSurfaceMedium = 'rgba(0, 0, 0, 0.62)';
export const onSurfaceLow = 'rgba(0, 0, 0, 0.34)';
export const onSurfaceLowest = 'rgba(0, 0, 0, 0.14)';

export const onPrimaryHigh = '#FFFFFF';
export const onPrimaryMedium = 'rgba(255, 255, 255, 0.7)';
export const onPrimaryLow = 'rgba(255, 255, 255, 0.4)';

export const error = '#FF4949';
export const warn = '#FFC82C';
export const success = '#13CE66';

export const surfaceGray = '#F5F5F5';
export const surfaceGrayDarker = '#EBEDF0';
export const surfaceSoft = rgba(primary, 0.12);
export const surfaceSoftGreen = rgba(coreGreen, 0.12);

export const strokeBlackPrimary = rgba(primary, 0.12);
export const strokeBlackSecondary = rgba(primary, 0.08);

export const strokeBrandPrimary = rgba(primary, 0.35);
export const strokeBrandSecondary = rgba(primary, 0.5);

export const bgMain = 'rgba(0,0,0,0.04)';
export const bgTransparent = 'transparent';
export const bgPrimary = rgba(primary, 0.6);
export const bgPrimaryDark = rgba(primary, 0.9);
export const bgDialog = 'rgba(0, 0, 0, 0.5)';
export const bgDialogDark = 'rgba(0, 0, 0, 0.7)';
export const bgGray = '#e6e6e6';
export const bgLight = '#FAFAFA';
export const bgUnread = '#ededfb';
export const bgInternal = '#fff0b2';
export const bgInvisible = '#0000';
export const bgActive = '#F0F0F0';
export const bgLightPurple = '#F7F8FC';
export const bgDark = rgba('#000', 0.95);
export const bgStage = '#e5e8ec';

export const linkPrimary = '#1785FC';
export const linkPrimaryHover = rgba(linkPrimary, 0.7);

export const textPrimary = '#252437';
export const textSecondary = '#616E7C';

export const borderPrimary = rgba('#000', 0.16);
export const borderDarker = '#DEE4E7';
